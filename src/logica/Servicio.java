...
public class Servicio {
    ...
    public Servicio(int k_id_servicio, int k_id_tipo_paquete, int k_num_documento_usuario, String k_tipo_documento_usuario, int k_num_documento_mensajero, String k_tipo_documento_mensajero, String f_fecha, String f_hora, String v_valor_servicio) {
